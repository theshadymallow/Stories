...
public delegate bool StateMachineEventFilter<in TInstance>(IEventContext<TInstance> context);
...
/// <param name="context">The event context</param>
/// <returns>True if the filter matches the data, otherwise false.</returns>
public delegate bool StateMachineEventFilter<in TInstance, in TData>(IEventContext<TInstance, TData> context);